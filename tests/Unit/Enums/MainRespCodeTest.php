...
class MainRespCodeTest extends TestCase
{
    public function test_app_version_outdated_values()
    {
        ...
        $this->assertEquals('Appversionoutdated error occurred.', MainRespCode::AppVersionOutdated->message());
    }
    ...
    public function test_app_missing_headers_values()
    {
        ...
        $this->assertEquals('Appmissingheaders error occurred.', MainRespCode::AppMissingHeaders->message());
    }
    ...
    public function test_app_wrong_language_values()
    {
        ...
        $this->assertEquals('Appwronglanguage error occurred.', MainRespCode::AppWrongLanguage->message());
    }
    ...
    public function test_validation_error_values()
    {
        ...
        $this->assertEquals('Validationerror error occurred.', MainRespCode::ValidationError->message());
    }
    ...
    public function test_app_invalid_device_model_values()
    {
        ...
        $this->assertEquals('Appinvaliddevicemodel error occurred.', MainRespCode::AppInvalidDeviceModel->message());
    }
}